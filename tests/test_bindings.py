...
def load_application():
    ...
    terminal = load_module('test_hud_terminal_backend', FILES / 'hud_terminal.py')
    with mock.patch.dict('sys.modules', {'bindings_keyboard': keyboard, 'hud_terminal': terminal}), \
...
class RuntimeChecks(unittest.TestCase):
    ...
    def test_missing_gtk_symbol_is_rejected_during_runtime_binding(self):
        ...
        terminal = load_module('test_hud_terminal_backend_missing', FILES / 'hud_terminal.py')
        with mock.patch.dict('sys.modules', {'bindings_keyboard': keyboard, 'hud_terminal': terminal}), \
